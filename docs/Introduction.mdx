...
<Meta title="Getting Started/With Frontend Design" />
...
- <a href="./?path=/docs/design-system-colors--docs">
    Documenting design tokens
  </a>
- <a href="./?path=/docs/components-button--default">Documenting components</a>

- <a href="./?path=/story/components-button--default&globals=theme:dark">
    Theme switching
  </a>
- And much more!

<div className="subheading">Important Resources</div>
<div className="link-list">
  
  <a className="link-item" href="https://www.chromatic.com" target="_blank">
    <img src={Chromatic} alt="chromatic" />
    <span>
      <strong>Chromatic project</strong>
