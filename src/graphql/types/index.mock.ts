...
export type ProfileDetailFragment = { __typename?: 'Profile', id: string, firstName: string | null, name: string, title: string, urn: string, country: string | null, city: string | null, educations: any | null, positions: any | null, skills: any | null, geoData: any | null, rawDataS3Key: string | null, cleanedDataS3Key: string | null, sourceFile: string, createdAt: string, updatedAt: string, profileEntry: { __typename?: 'ProfileEntry', id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } | null };
...
export type ProfileQuery = { __typename?: 'Query', profile: { __typename?: 'Profile', id: string, firstName: string | null, name: string, title: string, urn: string, country: string | null, city: string | null, educations: any | null, positions: any | null, skills: any | null, geoData: any | null, rawDataS3Key: string | null, cleanedDataS3Key: string | null, sourceFile: string, createdAt: string, updatedAt: string, profileEntry: { __typename?: 'ProfileEntry', id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } | null } | null };
