...
export type UpdateProfileEntryMutation = { updateProfileEntry: { id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } };
