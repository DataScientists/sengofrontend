...
export type ApiQuotaTrackerFragment = { id: string, month: number, year: number, callCount: number, quotaLimit: number, quotaExceeded: boolean, overrideEnabled: boolean, notificationSent: boolean, lastCallAt: string | null, createdAt: string };

export type AuthPayloadFragment = { accessToken: string, refreshToken: string, user: { id: string, name: string, email: string } };

export type JobExecutionHistoryFragment = { id: string, jobName: string, status: JobExecutionStatus, startedAt: string, completedAt: string | null, durationSeconds: number, totalProcessed: number, successfulCount: number, failedCount: number, apiCallsMade: number, quotaRemaining: number, errorSummary: string | null, createdAt: string };

export type JobStatsFragment = { totalExecutions: number, successRate: number, averageDuration: number, totalProfiles: number, totalAPICallsMade: number };

export type PageInfoFragment = { hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null };

export type ProfileDetailFragment = { id: string, firstName: string | null, lastName: string | null, name: string, username: string | null, headline: string | null, title: string, urn: string, country: string | null, city: string | null, educations: any | null, positions: any | null, skills: any | null, geoData: any | null, rawDataS3Key: string | null, cleanedDataS3Key: string | null, sourceFile: string | null, createdAt: string, updatedAt: string, profileEntry: { id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } | null };
...
export type ProfileEntryFragment = { id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string };

export type ProfilePostItemFragment = { id: string, profileUsername: string, postUrn: string | null, postUrl: string | null, text: string | null, contentType: string | null, isRepost: boolean, totalReactions: number, likeCount: number, commentsCount: number, repostsCount: number, empathyCount: number, praiseCount: number, funnyCount: number, interestCount: number, postedAt: string | null, createdAt: string };

export type ProfilePostFragment = { id: string, profileUsername: string, fetchStatus: ProfilePostFetchStatus, s3Key: string | null, errorMessage: string | null, createdAt: string, items: Array<{ id: string, profileUsername: string, postUrn: string | null, postUrl: string | null, text: string | null, contentType: string | null, isRepost: boolean, totalReactions: number, likeCount: number, commentsCount: number, repostsCount: number, empathyCount: number, praiseCount: number, funnyCount: number, interestCount: number, postedAt: string | null, createdAt: string }> };
...
export type CreateProfileEntryMutation = { createProfileEntry: { id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } };
...
export type FetchProfileEntryMutation = { fetchProfileEntry: boolean };
...
export type CurrentQuotaStatusQuery = { currentQuotaStatus: { id: string, month: number, year: number, callCount: number, quotaLimit: number, quotaExceeded: boolean, overrideEnabled: boolean, notificationSent: boolean, lastCallAt: string | null, createdAt: string } | null };
...
export type QuotaStatusQuery = { quotaStatus: { id: string, month: number, year: number, callCount: number, quotaLimit: number, quotaExceeded: boolean, overrideEnabled: boolean, notificationSent: boolean, lastCallAt: string | null, createdAt: string } | null };
...
export type JobHistoryListQuery = { jobExecutionHistoryList: { totalCount: number, edges: Array<{ node: { id: string, jobName: string, status: JobExecutionStatus, startedAt: string, completedAt: string | null, durationSeconds: number, totalProcessed: number, successfulCount: number, failedCount: number, apiCallsMade: number, quotaRemaining: number, errorSummary: string | null, createdAt: string } | null } | null> | null, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } };
...
export type JobHistoryQuery = { jobExecutionHistory: { id: string, jobName: string, status: JobExecutionStatus, startedAt: string, completedAt: string | null, durationSeconds: number, totalProcessed: number, successfulCount: number, failedCount: number, apiCallsMade: number, quotaRemaining: number, errorSummary: string | null, createdAt: string } | null };
...
export type JobStatsQuery = { jobStats: { totalExecutions: number, successRate: number, averageDuration: number, totalProfiles: number, totalAPICallsMade: number } };
...
export type ProfileQuery = { profile: { id: string, firstName: string | null, lastName: string | null, name: string, username: string | null, headline: string | null, title: string, urn: string, country: string | null, city: string | null, educations: any | null, positions: any | null, skills: any | null, geoData: any | null, rawDataS3Key: string | null, cleanedDataS3Key: string | null, sourceFile: string | null, createdAt: string, updatedAt: string, profileEntry: { id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } | null } | null };
...
export type ProfilePostsQuery = { profilePosts: { id: string, profileUsername: string, fetchStatus: ProfilePostFetchStatus, s3Key: string | null, errorMessage: string | null, createdAt: string, items: Array<{ id: string, profileUsername: string, postUrn: string | null, postUrl: string | null, text: string | null, contentType: string | null, isRepost: boolean, totalReactions: number, likeCount: number, commentsCount: number, repostsCount: number, empathyCount: number, praiseCount: number, funnyCount: number, interestCount: number, postedAt: string | null, createdAt: string }> } | null };
...
export type ProfileEntriesQuery = { profileEntries: { totalCount: number, edges: Array<{ node: { id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } | null } | null> | null, pageInfo: { hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } | null };
...
export type ProfileEntryQuery = { profileEntry: { id: string, linkedinUrn: string, gender: string | null, status: ProfileEntryStatus, lastFetchedAt: string | null, fetchCount: number, profileData: any | null, createdAt: string, updatedAt: string } | null };
