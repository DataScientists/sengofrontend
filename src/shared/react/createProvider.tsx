...
import React, { createContext, memo, useContext as useReactContext } from 'react';

export function createProvider<ContextProps extends object, Props extends object>(
