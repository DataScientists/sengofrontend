...
var spawnSync_1 = require("../util/spawnSync");
/**
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            argv = (0, yargs_1.default)((0, helpers_1.hideBin)(process.argv))
                ...
                .help()
                .parseSync();
            console.log("\uD83D\uDEE0  Generating atom component \"".concat(argv.component, "\"\u2026"));
            // run your hygen template
            (0, spawnSync_1.spawnSync)("npx hygen new chakrauiAtomComponent --componentName ".concat(argv.component));
            return [2 /*return*/];
        });
    });
}
